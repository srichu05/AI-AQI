...
// ShaderBackground — generated by the 21st.dev Shader Builder ("Smoke").
...
const UNIFORMS = {
  colors: [
    [0.39, 0.64, 0.89], // #64a3e3 Soft Light Sky
    [0.49, 0.75, 0.93], // #7ec0ee Powder Blue
    [0.62, 0.82, 0.96], // #9fd2f6 Soft Ice Blue
    [0.76, 0.89, 0.98], // #c2e4fa Very Light Icy Blue
    [0.87, 0.94, 0.99], // #deeffe Pristine Soft Blue
    [0.93, 0.97, 1.00], // #eef7ff Cloud White-Blue
    [0.53, 0.81, 0.98], // #87cefa Light Sky Blue
    [0.69, 0.88, 0.95]  // #b0e0f2 Crisp Pale Cyan-Blue
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const releaseTimer = window.setTimeout(() => {
        if (!canvas || pendingContextReleases.get(canvas) !== releaseTimer) return;
        pendingContextReleases.delete(canvas);
        if (gl) {
